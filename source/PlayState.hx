...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		else if (SONG.song.toLowerCase() == 'probed'
			|| SONG.song.toLowerCase() == 'brainfuck'
			|| SONG.song.toLowerCase() == 'lazerz'
			|| SONG.song.toLowerCase() == 'annihilation-lol')
		{
			defaultCamZoom = 0.9;
			curStage = 'park';
		...
		else if (SONG.song.toLowerCase() == 'not-funny')
		{
	...
	function xigIntro(?dialogueBox:DialogueBox):Void
	{
		remove(dad);
		remove(gf);
	...
	function xigIntroTwo(?dialogueBox:DialogueBox):Void
	{
		var black:FlxSprite = new FlxSprite(-100, -100).makeGraphic(FlxG.width * 2, FlxG.height * 2, FlxColor.BLACK);
		black.scrollFactor.set();
		add(black);
				...
				if (!daNote.mustPress && daNote.wasGoodHit)
				{
					...
					if (SONG.notes[Math.floor(curStep / 16)] != null)
					{
						...
						if (curSong == 'Annihilation-Lol')
						{
							switch (curStep)
							{
								case 139 | 201 | 205 | 215 | 216 | 219 | 146 | 156 | 199 | 204 | 210 | 161 | 164 | 178 | 186 | 200 | 203 | 209 | 217 | 168 |
									172 | 182 | 184 | 196 | 197 | 214 | 218:
									altAnim = '-alt';
									health += 0.0875;
							}
							...
							/*
								switch (curStep)
								{
									case 139 | 201 | 205 | 215 | 216 | 219:
										dad.playAnim('singDOWN-alt', false);
										health += 0.0875;
									case 146 | 156 | 199 | 204 | 210:
										dad.playAnim('singLEFT-alt', false);
										health += 0.0875;
									case 161 | 164 | 178 | 186 | 200 | 203 | 209 | 217:
										dad.playAnim('singUP-alt', false);
										health += 0.0875;
									case 168 | 172 | 182 | 184 | 196 | 197 | 214 | 218:
	...
	override function beatHit()
	{
		...
		if (curSong == 'Probed' && dad.curCharacter == 'alien' || dad.curCharacter == 'alien-alt')
		{
			switch (curBeat)
			{
				case(131):
